...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/v1/health","/api/v1/auth/**", "/api/v1/users/**", "/api/v1/sessions/**", "/api/v1/challenges/**", "/api/v1/subscriptions/**", "/api/v1/reports/**","/api/v1/demo-controller**").permitAll()
