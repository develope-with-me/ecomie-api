...
public class UserController {
    ...
    @Operation(summary = "Edit User Profile", description = "Modify currently authenticated user's profile information", tags = { "USER", "UserController" })
    ...
    @Operation(summary = "Edit User Profile", description = "Modify user's profile information using his id", tags = { "ADMIN", "UserController" })
    ...
    @Operation(summary = "Assign New Role", description = "Change user's role using userId", tags = { "ADMIN", "UserController" })
    ...
    @Operation(summary = "Get User Profile", description = "Get user's profile information using userId", tags = { "ADMIN", "UserController" })
...
//    @PreAuthorize("hasAuthority('USER') ")
    ...
    @Operation(summary = "Get User Profile", description = "Get currently authenticated user's information", tags = { "USER", "UserController" })
    ...
    @Operation(summary = "Get User's Profile Image", description = "Get user's profile image using userId", tags = { "ADMIN", "UserController" })
    ...
    @GetMapping("/user/pix")
    @Operation(summary = "Get User's Profile Image", description = "Get currently auth user's profile image", tags = { "USER", "UserController" })
    public ResponseEntity<byte[]> getProfileImage() {
        return new ResponseEntity<>(userService.getProfilePicture(), HttpStatus.OK);
    }

    @DeleteMapping("/admin/user-pix/{userId}/del")
    @Operation(summary = "Delete User's Profile Image", description = "Delete user's profile image using userId", tags = { "ADMIN", "UserController" })
    ...
    @Operation(summary = "Delete User's Profile Image", description = "Delete user using userId", tags = { "ADMIN", "UserController" })
    ...
    @Operation(summary = "Soft delete User's Profile Image", description = "Soft delete user using userId", tags = { "ADMIN", "UserController" })
    ...
    @Operation(summary = "Soft delete User's Profile Image", description = "Soft delete user using userId", tags = { "USER", "UserController" })
    ...
    @GetMapping("/admin/get-users/session/{sessionId}")
    @Operation(summary = "Get Session Users", description = "Get all blocked and/or unblocked users in a session", tags = { "ADMIN", "UserController" })
    public ResponseEntity<List<HelperDto.UserFullDto>> getUsersInASession(@PathVariable(name = "sessionId") UUID sessionId, @RequestParam(name = "blocked") boolean blocked, @RequestParam(name = "challengeId") Optional<UUID> optionalChallengeId) {
        return new ResponseEntity<List<HelperDto.UserFullDto>>(userService.getUsersInASession(sessionId, blocked, optionalChallengeId), HttpStatus.OK);
    }

    @GetMapping("/admin/get-users")
    @Operation(summary = "Get All Users", description = "Get all users in the system", tags = { "ADMIN", "UserController" })
    public ResponseEntity<List<HelperDto.UserFullDto>> getAllUsers() {
        return new ResponseEntity<List<HelperDto.UserFullDto>>(userService.getAllUsers(), HttpStatus.OK);
    }
}
