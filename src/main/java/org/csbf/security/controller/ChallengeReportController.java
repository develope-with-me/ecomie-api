...
private final ChallengeReportService reportService;
    ...
    protected ResponseEntity<ResponseMessage> createChallengeReport(@PathVariable(name = "sessionId") UUID sessionId, @RequestBody HelperDomain.ChallengeReportCreateDto challengeReportCreateDto) {
    ...
    protected ResponseEntity<ResponseMessage> createChallengeReportForUser(@PathVariable(name = "userId") UUID userId, @PathVariable(name = "sessionId") UUID sessionId, @RequestBody HelperDomain.ChallengeReportCreateDto challengeReportCreateDto) {
    ...
    public ResponseMessage updateChallengeReport(@PathVariable(name = "reportId") UUID reportId, @RequestBody HelperDomain.ChallengeReportCreateDto challengeReportCreateDto) {
    ...
    public ResponseMessage updateChallengeReportForUser(@PathVariable(name = "reportId") UUID reportId, @RequestBody HelperDomain.ChallengeReportCreateDto challengeReportCreateDto) {
    ...
    public HelperDomain.ChallengeReportFullDto getChallengeReport(@PathVariable(name = "reportId") UUID reportId) {
    ...
    public ResponseEntity<List<HelperDomain.ChallengeReportFullDto>> getChallengeReports() {
